...
def get_test_modules(module):
    ...
    results = _get_tests_modules(importlib.util.find_spec(f'app.addons.{module}'))
...
def _get_upgrade_test_modules(module):
    upgrade_modules = (
        f"app.upgrade.{module}",
        f"app.addons.{module}.migrations",
        f"app.addons.{module}.upgrades",
    )
