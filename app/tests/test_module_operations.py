...
from app import api
from app.tools import config, topological_sort, unique, profiler
from app.modules.registry import Registry
from app.netsvc import init_logger
from app.tests import standalone_tests
import app.tests.loader

_logger = logging.getLogger('app.tests.test_module_operations')
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Script for testing the install / uninstall / reinstall"
                    " cycle of DERACore modules. Prefer the 'cycle' subcommand to"
    ...
    parser.add_argument("--addons-path", "-p", type=addons_path,
        help="Comma-separated list of paths to directories containing extra DERACore modules")
...
def test_standalone(args):
    ...
    app.service.db._check_faketime_mode(args.database)  # noqa: SLF001
    ...
    for module_name in registry._init_modules:
        ...
        app.tests.loader.get_test_modules(module_name)
...
if __name__ == '__main__':
    ...
    if args.addons_path:
        ...
        app.modules.module.initialize_sys_path()
    ...
    logging.config.dictConfig({
        ...
        'loggers': {
            'app.modules.loading': {'level': 'CRITICAL'},
            'app.sql_db': {'level': 'CRITICAL'},
            'app.models.unlink': {'level': 'WARNING'},
            'app.addons.base.models.ir_model': {'level': "WARNING"},
        }
    })
