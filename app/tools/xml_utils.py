...
from app.tools.misc import file_open
...
class odoo_resolver(etree.Resolver):
    """DERACore specific file resolver that can be added to the XML Parser.
...
def _check_with_xsd(tree_or_str, stream, env=None, prefix=None):
    ...
    :param app.api.Environment env: If it is given, it enables resolving the
...
def load_xsd_files_from_url(env, url, file_name=None, force_reload=False,
    ...
    :param app.api.Environment env: environment of calling module
    ...
    :rtype: app.api.ir.attachment | bool
...
def validate_xml_from_attachment(env, xml_content, xsd_name, reload_files_function=None, prefix=None):
    ...
    :return: the result of the function :func:`app.tools.xml_utils._check_with_xsd`
    """
