...
class _Cleaner(clean.Cleaner):
    ...
    def kill_conditional_comments(self, doc):
        ...
        https://github.com/app/app/pull/119325/files#r1301064789
...
def tag_quote(el):
    ...
    # app, gmail and outlook automatic signature wrapper
...
def plaintext2html(text: str, container_tag: str | None = None, with_paragraph: bool = True) -> markupsafe.Markup:
    ...
    html entities, using :func:`~app.tools.misc.html_escape`.
...
def email_normalize(text, strict=True):
    ...
    within app, this assumption is certain to fall short for international
...
def _normalize_email(email):
    ...
    introduction of smtp-utf8 within app, this assumption is certain to fall
...
def encapsulate_email(old_email, new_email):
    ...
    * New From: notifications@app.com
    * Output: "Admin" <notifications@app.com>
    """
