...
This tool provides utilities to duplicate records across models in DERACore, while maintaining referential integrity,
...
from app.tools.sql import SQL
from app.fields import Field, Many2one
