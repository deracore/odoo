...
_BUBBLEUP_EXCEPTIONS = (
    app.exceptions.UserError,
    app.exceptions.RedirectWarning,
...
`app.tools.safe_eval.wrap_module` to generate a wrapper recursively
whitelisting allowed attributes.

Pre-wrapped modules are provided as attributes of `app.tools.safe_eval`.
""")
    return d
...
from app._monkeypatches.pytz import patch_module as patch_pytz  # noqa: E402, F401
patch_pytz()
