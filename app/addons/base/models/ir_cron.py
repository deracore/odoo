...
from app import api, fields, models, sql_db
from app.exceptions import LockError, UserError
from app.modules import Manifest
from app.modules.registry import Registry
from app.tools import SQL
from app.tools.constants import GC_UNLINK_LIMIT
...
class IrCron(models.Model):
    ...
    def _check_modules_state(cr, jobs):
        ...
        # reset_module_states.
        from app.modules.loading import reset_modules_state  # noqa: PLC0415
