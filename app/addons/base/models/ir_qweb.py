...
QWeb is the primary templating engine used by DERAcore. It is an XML templating
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
**Values**: name of the allowed app user group, or preceded by ``!`` for
prohibited groups

The generated code uses ``has_group`` DERAcore method from ``res.users`` model.
...
from app import api, models, tools
from app.modules import Manifest
from app.modules.registry import _REGISTRY_CACHES
from app.tools import config, safe_eval, OrderedSet, frozendict, json
from app.tools.constants import SUPPORTED_DEBUGGER, EXTERNAL_ASSET
from app.tools.safe_eval import assert_valid_codeobj, _BUILTINS, to_opcodes, _EXPR_OPCODES, _BLACKLIST
from app.tools.lru import LRU
from app.tools.misc import str2bool, file_open, file_path
from app.tools.image import image_data_uri, FILETYPE_BASE64_MAGICWORD
from app.tools.profiler import ExecutionContext
from app.tools.translate import FORMAT_REGEX
from app.http import request
from app.tools.profiler import QwebTracker
from app.exceptions import UserError, MissingError

from app.addons.base.models.assetsbundle import AssetsBundle
from app.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS, TEMPLATE_EXTENSIONS
    ...
    def _render_iterall(self, view_ref, method, values, directive='render') -> Iterator[str]:
        ...
        try:
            ...
            if hasattr(error, 'qweb'):
                ...
                # If is not an app Exception check if the current error is raise from
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since DERAcore 17.0, keep the value empty and configure the "
