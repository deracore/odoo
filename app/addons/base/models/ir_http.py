...
import app
from app import api, http, models, tools
from app.api import SUPERUSER_ID
from app.exceptions import AccessDenied
from app.http import ROUTING_KEYS, SAFE_HTTP_METHODS, Response, request
from app.modules.registry import Registry
from app.service import security
from app.tools.json import json_default
from app.tools.misc import get_lang, submap
from app.tools.translate import code_translations

_logger = logging.getLogger(__name__)

# see also mimetypes module: https://docs.python.org/3/library/mimetypes.html and app.tools.mimetypes
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (app.exceptions.AccessError, app.exceptions.MissingError) as e:
                ...
                if request.env.user.is_public or isinstance(e, app.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(app.tools.config['server_wide_modules'])
