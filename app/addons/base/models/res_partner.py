...
from app import api, fields, models, tools, _, Command
from app.exceptions import RedirectWarning, UserError, ValidationError
...
class ResPartner(models.Model):
    ...
    def write(self, vals):
        if vals.get('active') is False:
            ...
            # https://github.com/app/app/commit/9d7226371730e73c296bcc68eb1f856f82b0b4ed
            #
