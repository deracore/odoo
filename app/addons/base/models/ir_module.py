...
from app.exceptions import AccessDenied, UserError, ValidationError
from app.fields import Domain
from app.tools import config
from app.tools.parse_version import parse_version
from app.tools.misc import topological_sort, get_flag
from app.tools.translate import TranslationImporter, get_po_paths, get_datafile_translation_path
from app.http import request
from app.modules.module import Manifest, MissingDependency
...
class IrModuleModule(models.Model):
    ...
    def button_uninstall(self):
        un_installable_modules = set(app.tools.config['server_wide_modules']) & set(self.mapped('name'))
