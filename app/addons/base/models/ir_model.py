...
from app.tools import frozendict, reset_cached_properties, split_every, sql, unique, OrderedSet, SQL
from app.tools.safe_eval import safe_eval, datetime, dateutil, time
from app.tools.translate import FIELD_TRANSLATE, LazyTranslate, _
...
class IrModel(models.Model):
    ...
    def unlink(self):
        ...
        # reload is done independently in app.modules.loading.
...
class IrModelFields(models.Model):
    ...
    def _drop_column(self):
        from app.orm.model_classes import pop_field
...
class IrModelData(models.Model):
    ...
    def _module_data_uninstall(self, modules_to_remove):
        ...
        """
        from app.orm.model_classes import add_field
