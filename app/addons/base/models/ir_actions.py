...
from app.tools import _, frozendict, get_lang
from app.tools.float_utils import float_compare
from app.tools.misc import get_diff, unquote
from app.tools.safe_eval import safe_eval, test_python_expr
...
class IrActionsServer(models.Model):
    ...
    Since DERAcore 8.0 a button 'Create Menu Action' button is available on the
