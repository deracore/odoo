...
from app import api, Command, fields, models
from app.tools import OrderedSet
from app.tools.translate import _, code_translations, LazyTranslate
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str, *, savepoint):
        ...
        callable taking a record-ish (a dictionary representing an app
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`app.models.Model.write` expects.

        :param model: :class:`app.models.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str, *, savepoint):
        ...
        :type field: :class:`app.fields.Field`
