...
from app.exceptions import MissingError, UserError
from app.http import Stream, request
from app.tools import file_open, replace_exceptions
from app.tools.image import image_guess_size_from_field_name, image_process
from app.tools.mimetypes import MIMETYPE_HEAD_SIZE, get_extension, guess_mimetype
from app.tools.misc import verify_limited_field_access_token
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:app.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~app.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`app.tools.image.image_process`.
