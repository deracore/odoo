...
from app.tests.common import standalone
from app.tests.test_module_operations import install
from app.tools import mute_logger
from app.tools.convert import ParseError
...
def test_isolated_install(env):
    ...
    try:
        with mute_logger('app.modules.registry'):
