...
from app.addons.base.models.ir_qweb import QWebError
from app.tools import file_open, misc, mute_logger
from app.tools.json import scriptsafe as json_scriptsafe
from app.exceptions import UserError, MissingError
...
class TestQWebBasic(TransactionCase):
    ...
    def test_attf_escaping_2(self):
        ...
        result = """
                <a href="/link/app/sub">link</a>
                <a href="/link/app/">link2</a>
            """
    ...
    @mute_logger('app.addons.base.models.ir_qweb')
    ...
    @mute_logger('app.addons.base.models.ir_qweb') # warning for template not found
