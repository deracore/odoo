...
from app.addons.base.models.ir_mail_server import extract_rfc2822_addresses
from app.addons.base.models.ir_qweb_fields import nl2br_enclose
from app.tests import tagged
from app.tests.common import BaseCase
from app.tools import misc
from app.tools.mail import (
...
0 < 10 & \N{NO-BREAK SPACE} 10 > 0""")
        self.assertEqual(html2plaintext('<p><img src="/web/image/428-c064ab1b/test-image.jpg?access_token=f72b5ec5-a363-45fb-b9ad-81fc794d6d7b" class="img img-fluid app_we_custom_image"><br></p>'),
                         """test-image [1]
