...
from app.tests.common import BaseCase, TransactionCase, tagged, new_test_user, HttpCase
from app.tools import profiler
from app.tools.profiler import Profiler, ExecutionContext
from app.tools.speedscope import Speedscope
...
class TestProfiling(TransactionCase):
    ...
    def test_profiler_return(self):
        ...
        self.startClassPatcher(patch('app.sql_db.db_connect', return_value=self.registry))
