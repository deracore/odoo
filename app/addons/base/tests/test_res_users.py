...
from app.exceptions import AccessError, UserError, ValidationError
from app.fields import Command
from app.http import _request_stack
from app.tests import Form, TransactionCase, new_test_user, tagged, HttpCase, users, warmup
...
class TestUsers(UsersCommonCase):
    ...
    @mute_logger('app.sql_db', 'app.addons.base.models.res_users_deletion')
    ...
    def test_context_get_lang(self):
        ...
        request_patch = patch('app.addons.base.models.res_users.request', request)
...
class TestUsers2(UsersCommonCase):
    ...
    def test_view_group_hierarchy(self):
        ...
        with patch('app.addons.base.models.res_groups.ResGroups._get_view_group_hierarchy') as mock:
