...
from app.tests.common import BaseCase, HttpCase
from app.tests.test_cursor import TestCursor
from app.tools.misc import config
...
class TestTestCursor(common.TransactionCase):
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('app.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:app.sql_db:Found different un-closed cursor', msg)
