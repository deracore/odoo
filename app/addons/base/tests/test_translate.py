...
from app.tools.translate import quote, unquote, xml_translate, html_translate, TranslationImporter, TranslationModuleReader
from app.tests.common import TransactionCase, BaseCase, new_test_user, tagged

_stats_logger = logging.getLogger('app.tests.stats')
...
class TestLanguageInstall(TransactionCase):
    def test_language_install(self):
        ...
        with patch('app.addons.base.models.ir_module.IrModuleModule._load_module_terms', _load_module_terms):
            wizard.lang_install()
...
class TestTranslationExport(TransactionCase):
    ...
    def test_export_translatable_resources(self):
        ...
        with self.assertNoLogs('app.tools.translate', "ERROR"):
...
class TestTranslation(TransactionCase):
    ...
    #     country_1 = Country.create({'name': 'DERACore'})
    ...
    #         country_2.name = 'DERACore'
    #         country_2.flush_recordset()
    #
    #     with self.assertRaises(IntegrityError), mute_logger('app.sql_db'):
    #         country_3 = Country.create({'name': 'DERACore'})
