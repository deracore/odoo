...
from app.addons.base.tests import mail_examples
from app.addons.base.tests.common import MockSmtplibCase
from app.tests import tagged, users
...
class TestIrMailServer(TransactionCase, MockSmtplibCase):
    ...
    @mute_logger('app.models.unlink', 'app.addons.base.models.ir_mail_server')
    ...
    def test_mail_server_config_bin(self):
        """ Test the configuration provided in the app-bin arguments. This config
        ...
        app-bin argument "--from-filter".
        """
        IrMailServer = self.env['ir.mail_server']

        # Remove all mail server so we will use the app-bin arguments
        ...
        # for from_filter in ICP, overwrite the one from app-bin
    ...
    def test_mail_server_config_cli(self):
        ...
        "cli". It should take the configuration from the app-bin argument. The
        ...
        for mail_from, (expected_smtp_from, expected_msg_from, expected_mail_server) in zip(
            [
                # check that the CLI server take the configuration in the app-bin argument
