...
from app.addons.base.models.res_partner import ResPartner
from app.addons.base.tests.common import TransactionCaseWithUserDemo
from app.exceptions import AccessError, RedirectWarning, UserError, ValidationError
from app.tests import Form
from app.tests.common import new_test_user, tagged, TransactionCase, users
