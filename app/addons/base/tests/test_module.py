...
import app.addons
from app.modules.module import Manifest
from app.release import major_version
...
class TestModuleManifest(BaseCase):
    ...
    def setUpClass(cls):
        ...
        patcher = patch.object(app.addons, '__path__', [cls.addons_path])
    ...
    def test_default_manifest(self):
        ...
        with self.assertNoLogs('app.modules.module', 'WARNING'):
    ...
    def test_missing_manifest(self):
        with self.assertLogs('app.modules.module', 'DEBUG') as capture:
    ...
    def test_missing_license(self):
        ...
        with self.assertLogs('app.modules.module', 'WARNING') as capture:
            manifest = Manifest.for_addon(self.module_name)
