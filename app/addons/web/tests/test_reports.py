...
from app.addons.http_routing.tests.common import MockRequest
from app.exceptions import UserError
from app.http import root
from app.tools import mute_logger


class TestReports(app.tests.HttpCase):
    def test_report_session_cookie(self):
        """ Asserts wkhtmltopdf forwards the user session when requesting resources to DERAcore, such as images,
    ...
    @mute_logger('app.addons.base.models.ir_actions_report')
