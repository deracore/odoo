...
from app.addons.base.tests.common import TransactionCaseWithUserPortal
from app.exceptions import AccessError
from app.fields import Command
from app.tests.common import HttpCase, tagged
...
class TestPartnerVCard(HttpCase):
    ...
    def test_check_partner_access_for_user(self):
        ...
        with mute_logger('app.http'):  # mute 403 warning
            res = self.url_open('/web/partner/vcard?partner_ids=%s,%s' %
                            (self.partners[0].id, self.partners[1].id))
