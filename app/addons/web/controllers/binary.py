...
try:
    ...
    from app.tools._vendor.send_file import send_file

import app
import app.modules.registry
from app import SUPERUSER_ID, _, http, api
from app.addons.base.models.assetsbundle import ANY_UNIQUE
from app.exceptions import AccessError, UserError
from app.http import request, Response
from app.tools import file_open, file_path, replace_exceptions, str2bool
from app.tools.image import image_guess_size_from_field_name
from app.tools.mimetypes import guess_mimetype
...
class Binary(http.Controller):
    ...
    def content_filestore(self, _path):
        if app.tools.config['x_sendfile']:
            # pylint: disable=logging-format-interpolation
            _logger.error(BAD_X_SENDFILE_ERROR.format(
                data_dir=app.tools.config['data_dir']
            ))
    ...
    def company_logo(self, dbname=None, **kw):
        ...
        imgext = '.png'
        dbname = request.db
        uid = (request.session.uid if dbname else None) or app.SUPERUSER_ID
