...
import { Component, useRef, useState, markup } from "@app/owl";
...
export const appExceptionTitleMap = new Map(
    Object.entries({
        "app.addons.base.models.ir_mail_server.MailDeliveryException": _t("MailDeliveryException"),
        "app.exceptions.AccessDenied": _t("Access Denied"),
        "app.exceptions.MissingError": _t("Missing Record"),
        "app.addons.web.controllers.action.MissingActionError": _t("Missing Action"),
        "app.addons.base.models.ir_actions.ServerActionWithWarningsError": _t("Invalid Operation"),
        "app.exceptions.UserError": _t("Invalid Operation"),
        "app.exceptions.ValidationError": _t("Validation Error"),
        "app.exceptions.AccessError": _t("Access Error"),
        "app.exceptions.Warning": _t("Warning"),
    })
);
...
export class ErrorDialog extends Component {
    ...
    static title = _t("DERAcore Error");
...
ClientErrorDialog.title = _t("DERAcore Client Error");

// -----------------------------------------------------------------------------
// Network Error Dialog
// -----------------------------------------------------------------------------
export class NetworkErrorDialog extends ErrorDialog {}
NetworkErrorDialog.title = _t("DERAcore Network Error");
...
export class RPCErrorDialog extends ErrorDialog {
    ...
    inferTitle() {
        ...
        if (this.props.exceptionName && appExceptionTitleMap.has(this.props.exceptionName)) {
            this.title = appExceptionTitleMap.get(this.props.exceptionName).toString();
            return;
        }
        ...
        switch (this.props.type) {
            case "server":
                this.title = _t("DERAcore Server Error");
                break;
            case "script":
                this.title = _t("DERAcore Client Error");
                break;
            case "network":
                this.title = _t("DERAcore Network Error");
                break;
        }
    }
...
export class WarningDialog extends Component {
    ...
    inferTitle() {
        if (this.props.exceptionName && appExceptionTitleMap.has(this.props.exceptionName)) {
            return appExceptionTitleMap.get(this.props.exceptionName).toString();
        }
        return this.props.title || _t("DERAcore Warning");
    }
}
...
export class RedirectWarningDialog extends Component {
    ...
    setup() {
        ...
        this.title = capitalize(subType) || _t("DERAcore Warning");
        this.message = message;
...
registry
    ...
    .add("app.exceptions.AccessDenied", WarningDialog)
    .add("app.exceptions.AccessError", WarningDialog)
    .add("app.exceptions.MissingError", WarningDialog)
    .add("app.addons.web.controllers.action.MissingActionError", WarningDialog)
    .add("app.addons.base.models.ir_actions.ServerActionWithWarningsError", WarningDialog)
    .add("app.exceptions.UserError", WarningDialog)
    .add("app.exceptions.ValidationError", WarningDialog)
    .add("app.exceptions.RedirectWarning", RedirectWarningDialog)
    .add("app.http.SessionExpiredException", SessionExpiredDialog)
