 ...
 */
export function appmark(text) {
    /**
     * Mapping of patterns - replacer functions to apply to appmarked strings.
     *
     ...
     *
     * Note: this list is declared inline in the `appmark` function to avoid other
