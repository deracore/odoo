...
import { Component, useRef, useSubEnv } from "@app/owl";
 ...
 * It uses a feature to automatically create links to other app pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
