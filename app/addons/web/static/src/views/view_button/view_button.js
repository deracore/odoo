...
export class ViewButton extends Component {
    ...
    get hasBigTooltip() {
        return Boolean(app.debug) || this.clickParams.help;
    }
    ...
    getClassName() {
        ...
        if (this.props.className) {
            for (let cls of this.props.className.split(" ")) {
                if (cls in appToBootstrapClasses) {
                    cls = appToBootstrapClasses[cls];
                }
                classNames.push(cls);
