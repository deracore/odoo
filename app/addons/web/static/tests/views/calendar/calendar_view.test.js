...
import { mockDate, mockTimeZone } from "@app/hoot-mock";
import { Component, onRendered, onWillStart, xml } from "@app/owl";
import {
    MockServer,
    contains,
    defineActions,
...
/**
 * @param {import("@app/hoot-dom").Target} from
 * @param {import("@app/hoot-dom").Target} to
 * @param {{
