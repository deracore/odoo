...
test("properly compile simple div", () => {
    ...
    const expected = /*xml*/ `
        <t t-translation="off">
            <div class="app_form_renderer app_form_nosheet" t-att-class="__comp__.props.class" t-attf-class="{{__comp__.props.record.isInEdition ? 'app_form_editable' : 'app_form_readonly'}} d-block {{ __comp__.props.record.dirty ? 'app_form_dirty' : !__comp__.props.record.isNew ? 'app_form_saved' : '' }}" t-ref="compiled_view_root">
                <div>lol</div>
            </div>
        </t>
    `;
            ...
            <div class="app_form_renderer app_form_nosheet" t-att-class="__comp__.props.class" t-attf-class="{{__comp__.props.record.isInEdition ? 'app_form_editable' : 'app_form_readonly'}} d-block {{ __comp__.props.record.dirty ? 'app_form_dirty' : !__comp__.props.record.isNew ? 'app_form_saved' : '' }}" t-ref="compiled_view_root">
                <OuterGroup>
                    <t t-set-slot="item_0" type="'item'" sequence="0" t-slot-scope="scope" isVisible="true" itemSpan="1">
                        <InnerGroup class="scope &amp;&amp; scope.className">
                            <t t-set-slot="item_0" type="'item'" sequence="0" t-slot-scope="scope" isVisible="true" itemSpan="1">
                                <div class="app_form_renderer app_form_nosheet" t-att-class="__comp__.props.class" t-attf-class="{{__comp__.props.record.isInEdition ? 'app_form_editable' : 'app_form_readonly'}} d-block {{ __comp__.props.record.dirty ? 'app_form_dirty' : !__comp__.props.record.isNew ? 'app_form_saved' : '' }} {{scope &amp;&amp; scope.className || &quot;&quot; }}">
...
test("properly compile no sheet", () => {
    ...
    const expected = /*xml*/ `
        <t t-translation="off">
            <div class="app_form_renderer app_form_nosheet" t-att-class="__comp__.props.class" t-attf-class="{{__comp__.props.record.isInEdition ? 'app_form_editable' : 'app_form_readonly'}} d-block {{ __comp__.props.record.dirty ? 'app_form_dirty' : !__comp__.props.record.isNew ? 'app_form_saved' : '' }}" t-ref="compiled_view_root">
                <div t-att-class="{ 'shadow-sm': __comp__.state.isStatusbarStickyPinned }" class="app_form_statusbar d-flex justify-content-between py-2">
                    <StatusBarButtons/>
                </div>
                <div>someDiv</div>
            </div>
...
test("properly compile sheet", () => {
    ...
    const expected = /*xml*/ `
        <t t-translation="off">
            <div class="app_form_renderer" t-att-class="__comp__.props.class" t-attf-class="{{__comp__.props.record.isInEdition ? 'app_form_editable' : 'app_form_readonly'}} d-flex d-print-block {{ __comp__.uiService.size &lt; 5 ? &quot;flex-column&quot; : &quot;flex-nowrap h-100&quot; }} {{ __comp__.props.record.dirty ? 'app_form_dirty' : !__comp__.props.record.isNew ? 'app_form_saved' : '' }}" t-ref="compiled_view_root">
                <div t-on-scroll="__comp__.onScrollThrottled" class="app_form_sheet_bg">
                    <div t-att-class="{ 'shadow-sm': __comp__.state.isStatusbarStickyPinned }" class="app_form_statusbar d-flex justify-content-between py-2"><StatusBarButtons/></div>
                    <div>someDiv</div>
                    <div class="app_form_sheet position-relative">
                        <div>inside sheet</div>
                    </div>
                </div>
                <div>after sheet</div>
...
test("properly compile buttonBox invisible in sheet", () => {
    ...
    const expected = /*xml*/ `
        <t t-translation="off">
            <div class="app_form_renderer"
                 t-att-class="__comp__.props.class"
                 t-attf-class="{{__comp__.props.record.isInEdition ? 'app_form_editable' : 'app_form_readonly'}} d-flex d-print-block {{ __comp__.uiService.size &lt; 5 ? &quot;flex-column&quot; : &quot;flex-nowrap h-100&quot; }} {{ __comp__.props.record.dirty ? 'app_form_dirty' : !__comp__.props.record.isNew ? 'app_form_saved' : '' }}"
...
test("keep nosheet style if a sheet is part of a nested form", () => {
    ...
    const expected = `<t t-translation="off">
        <div
            class="app_form_renderer app_form_nosheet"
            t-att-class="__comp__.props.class"
            t-attf-class="{{__comp__.props.record.isInEdition ? 'app_form_editable' : 'app_form_readonly'}} d-block {{ __comp__.props.record.dirty ? 'app_form_dirty' : !__comp__.props.record.isNew ? 'app_form_saved' : '' }}"
            t-ref="compiled_view_root"
        >
            <Field
                id="'move_line_ids'"
