...
/**
 * @typedef {import("@app/hoot").DragHelpers} DragHelpers
 * @typedef {import("@app/hoot").DragOptions} DragOptions
 * @typedef {import("@app/hoot").FillOptions} FillOptions
 * @typedef {import("@app/hoot").InputValue} InputValue
 * @typedef {import("@app/hoot").KeyStrokes} KeyStrokes
 * @typedef {import("@app/hoot").PointerOptions} PointerOptions
 * @typedef {import("@app/hoot").Position} Position
 * @typedef {import("@app/hoot").QueryOptions} QueryOptions
 * @typedef {import("@app/hoot").Target} Target
 *
 * @typedef {DragOptions & {
