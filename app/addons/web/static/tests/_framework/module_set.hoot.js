...
class ModuleSetLoader extends loader.constructor {
    ...
    constructor(moduleSet) {
        ...
        app.define = this.define.bind(this);
        app.loader = this;
    }
...
const AUTO_INCLUDED_ADDONS = {
    /**
     * spreadsheet addons defines a module that does not starts with `@spreadsheet` but `@app` (`@app/o-spreadsheet)
     * To ensure that this module is loaded, we have to include `app` in the dependencies
     */
    spreadsheet: ["app"],
    /**
...
const CSRF_TOKEN = app.csrf_token;
...
const R_DEFAULT_MODULE = /^@app\/(owl|hoot)/;
