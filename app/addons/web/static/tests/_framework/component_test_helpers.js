import { after, destroy, getFixture, queryFirst, queryOne } from "@app/hoot";
import { App, Component, xml } from "@app/owl";
 ...
 * @typedef {import("@app/owl").Component} Component
 ...
 * @template [P=any]
 * @template [E=any]
 * @typedef {import("@app/owl").ComponentConstructor<P, E>} ComponentConstructor
 */
