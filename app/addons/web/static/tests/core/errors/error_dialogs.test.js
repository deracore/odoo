...
import { describe, test, expect } from "@app/hoot";
import { animationFrame, tick } from "@app/hoot-mock";
import {
    mountWithCleanup,
    patchWithCleanup,
    mockService,
...
import { click, freezeTime, queryAllTexts } from "@app/hoot-dom";
import {
    ClientErrorDialog,
    Error504Dialog,
    ErrorDialog,
...
test("WarningDialog", async () => {
    ...
    await mountWithCleanup(WarningDialog, {
        env,
        props: {
            exceptionName: "app.exceptions.UserError",
            message: "...",
