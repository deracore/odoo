import { destroy, expect, getFixture, onError, test } from "@app/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne } from "@app/hoot-dom";
import { animationFrame, mockUserAgent, tick } from "@app/hoot-mock";
import { Component, useRef, useState, xml } from "@app/owl";
import {
    contains,
    getService,
    makeMockEnv,
