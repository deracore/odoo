...
import { htmlEscape, markup } from "@app/owl";
...
test("appmark", () => {
    expect(appmark("").toString()).toBe("");
    expect(appmark("**test**").toString()).toBe("<b>test</b>");
    expect(appmark("**test** something else **test**").toString()).toBe(
        "<b>test</b> something else <b>test</b>"
    );
    expect(appmark("--test--").toString()).toBe(`<span class="text-muted">test</span>`);
    expect(appmark("--test-- something else --test--").toString()).toBe(
    ...
    expect(appmark("<p>**test**</p>").toString()).toBe("&lt;p&gt;<b>test</b>&lt;/p&gt;");
    expect(appmark(markup`<p>**test**</p>`).toString()).toBe("<p><b>test</b></p>");
});
