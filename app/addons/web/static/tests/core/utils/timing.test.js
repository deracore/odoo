import { describe, destroy, expect, getFixture, test } from "@app/hoot";
import { click, tick } from "@app/hoot-dom";
import { Deferred, advanceTime, animationFrame, microTick, runAllTimers } from "@app/hoot-mock";
