/** @app-module alias=@web/../tests/mobile/core/action_swiper_tests default=false */

import { beforeEach, expect, test } from "@app/hoot";
import { hover, queryFirst } from "@app/hoot-dom";
import { advanceTime, animationFrame, mockTouch } from "@app/hoot-mock";
import { Component, onPatched, xml } from "@app/owl";
import {
    contains,
    defineParams,
    mountWithCleanup,
