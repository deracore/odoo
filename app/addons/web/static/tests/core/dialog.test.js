import { destroy, expect, test } from "@app/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne, resize } from "@app/hoot-dom";
import { animationFrame } from "@app/hoot-mock";
import { Component, onMounted, useState, xml } from "@app/owl";
import {
    contains,
    getService,
    makeDialogMockEnv,
