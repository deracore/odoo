import { getFixture, after } from "@app/hoot";
...
export async function startInteractions(
    ...
    if (app.loader.modules.has("@mail/../tests/mail_test_helpers")) {
        const { defineMailModels } = app.loader.modules.get("@mail/../tests/mail_test_helpers");
        defineMailModels();
    }
