import { beforeEach, expect, getFixture, test } from "@app/hoot";
import { microTick, tick } from "@app/hoot-dom";
...
const ModuleLoader = Object.getPrototypeOf(app.loader.constructor);
