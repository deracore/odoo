import { beforeEach, destroy, expect, test } from "@app/hoot";
import { queryAll, queryAllAttributes, queryAllTexts, resize } from "@app/hoot-dom";
import { advanceTime, animationFrame, runAllTimers } from "@app/hoot-mock";
import {
    clearRegistry,
    contains,
    defineMenus,
...
import { Component, onRendered, xml } from "@app/owl";
