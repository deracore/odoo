...
import { click, queryAllAttributes, queryAllProperties, queryAllTexts } from "@app/hoot-dom";
...
import { appAccountItem, preferencesItem } from "@web/webclient/user_menu/user_menu_items";
...
test("click on app account item", async () => {
    patchWithCleanup(browser, {
        open: (url) => expect.step(`open ${url}`),
    });
    userMenuRegistry.add("app_account", appAccountItem);
    await mountWithCleanup(UserMenu);
