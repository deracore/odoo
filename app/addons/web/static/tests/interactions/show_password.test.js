...
import { click, queryOne } from "@app/hoot-dom";
...
const template = `
    <div class="input-group">
        ...
        <button class="btn border border-start-0 app_show_password" type="button">
            <i class="fa fa-eye"></i>
        </button>
    </div>
`;

test("show_password is started when there is a .app_show_password", async () => {
...
test("input type changes on clicking the eye icon", async () => {
    ...
    const showEl = queryOne(".app_show_password");
