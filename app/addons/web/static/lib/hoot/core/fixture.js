...
import { animationFrame } from "@app/hoot-dom";
import { App } from "@app/owl";
...
/**
 * @typedef {Parameters<typeof import("@app/owl").mount>[2] & {
 *  className: string | string[];
 *  target?: import("@app/hoot-dom").Target;
 * }} MountOnFixtureOptions
 *
 * @typedef {{
 *  component: import("@app/owl").ComponentConstructor;
 *  props: unknown;
 * }} TestRootProps
 */
...
/**
 * @param {App | import("@app/owl").Component} target
 */
