...
import { after, describe, expect, mockFetch, test } from "@app/hoot";
...
describe(parseUrl(import.meta.url), () => {
    ...
    test("fetch with internal URLs should return default value", async () => {
        ...
        const internal = await fetch("/app").then((res) => res.text());
        ...
        expect.verifySteps(["http://some.url", "/app", "data:text/html,<body></body>"]);
    });
