...
import {Component, onWillStart, useState} from "@app/owl";
...
patch(WebClient.prototype, {
    setup() {
        ...
        useBus(this.env.bus, "APPS_MENU:STATE_CHANGED", ({detail: state}) => {
            document.body.classList.toggle("app_apps_menu_opened", state);
        });
...
export class AppsMenu extends Component {
    ...
    _onWindowKeydown(direction) {
        const focusableInputElements = document.querySelectorAll(".app-menu-item");
