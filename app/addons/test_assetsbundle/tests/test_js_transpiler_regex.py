...
from app.tools.js_transpiler import URL_RE, ODOO_MODULE_RE
...
class TestJsTranspiler(TransactionCase):
    ...
    def test_correct_ODOO_MODULE_RE(self):
        cases = [
            ...
            '/*@app-module',
            '/**@app-module',
            '// @app-module alias=web.test',
            '/* @app-module  alias=web.test',
            '/** @app-module  alias=web.test',
            '/** @app-module  alias=web.test**/',
            '/* @app-module  alias=web.test ',
            '/* @app-module alias=web.test default=false',
            '/* @app-module alias=web.test default=false ',
            '/* @app-module alias=web.test default=false**/',
        ]
    ...
    def test_incorrect_ODOO_MODULE_RE(self):
        ...
        cases = [
            '// @app-modulealias=web.test',
            '/* @app-module alias=web.testdefault=false',
        ]
