...
import app.modules
from app import api
from app.addons.base.models.assetsbundle import AssetsBundle, XMLAssetError, ANY_UNIQUE
from app.addons.base.models.ir_asset import AssetPaths
from app.addons.base.models.ir_attachment import IrAttachment
from app.tests import HttpCase, tagged
from app.tests.common import TransactionCase
from app.tools import mute_logger
from app.tools.misc import file_path
...
class TestAddonPaths(TransactionCase):
    def test_operations(self):
        ...
        asset_paths.append([
            ('/home/user/app/addons/web/a', '/web/a', 1),
            ('/home/user/app/addons/web/c', '/web/c', 1),
            ('/home/user/app/addons/web/d', '/web/d', 1),
        ], 'bundle1')
        self.assertEqual(asset_paths.list, [
            ('/home/user/app/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/app/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/app/addons/web/d', '/web/d', 'bundle1', 1),
        ])

        # append with a duplicate of 'c'
        asset_paths.append([
            ('/home/user/app/addons/web/c', '/web/c', 1),
            ('/home/user/app/addons/web/f', '/web/f', 1),
        ], 'bundle2')
        self.assertEqual(asset_paths.list, [
            ('/home/user/app/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/app/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/app/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/app/addons/web/f', '/web/f', 'bundle2', 1),
        ])

        # insert with a duplicate of 'c' after 'c'
        asset_paths.insert([
            ('/home/user/app/addons/web/c', '/web/c', 1),
            ('/home/user/app/addons/web/e', '/web/e', 1),
        ], 'bundle3', 3)
        self.assertEqual(asset_paths.list, [
            ('/home/user/app/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/app/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/app/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/app/addons/web/e', '/web/e', 'bundle3', 1),
            ('/home/user/app/addons/web/f', '/web/f', 'bundle2', 1),
        ])

        # insert with a duplicate of 'd' before 'd'
        asset_paths.insert([
            ('/home/user/app/addons/web/b', '/web/b', 1),
            ('/home/user/app/addons/web/d', '/web/d', 1),
        ], 'bundle4', 1)
        self.assertEqual(asset_paths.list, [

            ('/home/user/app/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/app/addons/web/b', '/web/b', 'bundle4', 1),
            ('/home/user/app/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/app/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/app/addons/web/e', '/web/e', 'bundle3', 1),
            ('/home/user/app/addons/web/f', '/web/f', 'bundle2', 1),
        ...
        asset_paths.remove([
            ('/home/user/app/addons/web/c', '/web/c', 1),
            ('/home/user/app/addons/web/d', '/web/d', 1),
            ('/home/user/app/addons/web/g', '/web/g', 1),
        ], 'bundle5')
        self.assertEqual(asset_paths.list, [
            ('/home/user/app/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/app/addons/web/b', '/web/b', 'bundle4', 1),
...
class AddonManifestPatched(TransactionCase):
    def setUp(self):
        ...
        self.manifests = Manifests(app.modules.Manifest.for_addon)

        self.patch(self.env.registry, '_init_modules', self.installed_modules)
        self.patch(app.modules.Manifest, 'for_addon', lambda module, **kw: self.manifests[module])
...
class TestJavascriptAssetsBundle(FileTouchable):
    ...
    def test_15_rtl_invalid_css_generation(self):
        ...
        with mute_logger('app.addons.base.models.assetsbundle'):
            self.bundle.css()
...
class TestAssetsManifest(AddonManifestPatched):
    ...
    @mute_logger('app.addons.base.models.ir_asset')
    def test_31(self):
