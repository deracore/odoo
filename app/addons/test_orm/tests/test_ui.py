...
@app.tests.common.tagged('post_install', '-at_install')
class TestUi(HttpCaseWithUserDemo):
    ...
    def test_01_admin_widget_x2many(self):
        ...
        self.start_tour("/app/action-test_orm.action_discussions",
            'widget_x2many', login="admin", timeout=120)


@app.tests.tagged('-at_install', 'post_install')
class TestUiTranslation(app.tests.HttpCase):

    @mute_logger('app.sql_db', 'app.http')
    def test_01_sql_constraints(self):
        ...
        self.start_tour("/app/action-test_orm.action_categories",
