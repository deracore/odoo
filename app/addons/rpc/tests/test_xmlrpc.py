...
import app
import app.tools
from app.exceptions import AccessDenied, AccessError
from app.http import _request_stack
from app.service import common as auth
from app.service import model
from app.tests import common
from app.tools import DotDict, mute_logger

from app.addons.base.tests.common import SavepointCaseWithUserDemo
...
class TestXMLRPC(common.HttpCase):
    ...
    def setUp(self):
        ...
        ml_xml = mute_logger('app.addons.rpc.controllers.xmlrpc')
        ml_xml.__enter__()  # noqa: PLC2801
        self.addCleanup(ml_xml.__exit__)

        ml_json = mute_logger('app.addons.rpc.controllers.jsonrpc')
    ...
    def test_xmlrpc_defaultdict_marshalling(self):
        ...
        self.patch(self.registry['res.users'], 'context_get',
                   app.api.model(lambda *_: collections.defaultdict(int)))
