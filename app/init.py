...
assert sys.version_info > MIN_PY_VERSION, f"Outdated python version detected, DERACore requires Python >= {'.'.join(map(str, MIN_PY_VERSION))} to run."

# ----------------------------------------------------------
# Set gc thresolds if they are default, see `app.tools.gc`.
...
# ----------------------------------------------------------
# Shortcuts
# Expose them at the `app` namespace level
# ----------------------------------------------------------
import app
