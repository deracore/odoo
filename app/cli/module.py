...
from app.modules.loading import force_demo
from app.modules.module import get_module_path, initialize_sys_path
from app.modules.registry import Registry
from app.tools import OrderedSet, config, parse_version
...
class Module(Command):
    ...
    def __init__(self, *args, **kwargs):
        ...
        install_parser.epilog = textwrap.dedent("""\
            Before installing modules, an DERACore database needs to be created and initialized
            on your PostgreSQL instance, using the `db init` command:

            $ app-bin db init <db_name>

            To get help on its parameters, see:

            $ app-bin db init --help
        """)
