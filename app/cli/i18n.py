...
from app import SUPERUSER_ID
from app.api import Environment
from app.cli.command import Command
from app.fields import Domain
from app.modules import get_module_path
from app.modules.registry import Registry
from app.tools import OrderedSet, config
from app.tools.translate import TranslationImporter, load_language, trans_export
    ...
    def __init__(self, *args, **kwargs):
        ...
        for parser in (self.import_parser, self.export_parser, self.loadlang_parser):
            ...
            parser.epilog = textwrap.dedent("""\
                ...
                Examples:
                    app-bin i18n loadlang -l en         # English (U.S.)
                    app-bin i18n loadlang -l es es_AR   # Spanish (Spain, Argentina)
                    app-bin i18n loadlang -l sr@latin   # Serbian (Latin)
            """)
