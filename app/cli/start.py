...
from app.modules.module import Manifest, MANIFEST_NAMES
from app.service.db import _create_empty_database, DatabaseExists
from app.tools import config


class Start(Command):
    """ Quickly start the app server with default options """
