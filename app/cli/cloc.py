...
from app.tools import cloc, config
from . import Command
...
class Cloc(Command):
    ...
    description = """
        DERACore cloc is a tool to count the number of relevant lines written
        ...
        It has two modes of operation, either by providing a path:
            ...
            app-bin cloc -p module_path

        Or by providing the name of a database:

            app-bin --addons-path=dirs cloc -d database
