...
import app.upgrade
from app.modules.module import load_script
from app.orm.registry import Registry
from app.tools.misc import file_path
from app.tools.parse_version import parse_version

if typing.TYPE_CHECKING:
    from collections.abc import Iterator
    from app.sql_db import Cursor
...
VERSION_RE = re.compile(
    r"""^
        # Optional prefix with DERACore version
        ((
            6\.1|
        ...
        # After DERACore version we allow precisely 2 or 3 parts
...
class MigrationManager:
    ...
    def _get_files(self) -> None:
        def _get_upgrade_path(pkg: str) -> Iterator[str]:
            for path in app.upgrade.__path__:
    ...
    def migrate_module(self, pkg: module_graph.ModuleNode, stage: typing.Literal['pre', 'post', 'end']) -> None:
        ...
        def compare(version: str) -> bool:
            ...
            if majorless_version:
                # We should not re-execute major-less scripts when upgrading to new DERACore version
