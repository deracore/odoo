...
from app.tools import reset_cached_properties, OrderedSet
from app.tools.sql import column_exists
...
class ModuleNode:
    """
    Loading and upgrade info for an DERACore module
    """
...
class ModuleGraph:
    """
    Sorted DERACore modules ordered by (module.phase, module.depth, module.name)
    """
