...
from app.exceptions import AccessError, MissingError
from app.tools import Query, SQL, reset_cached_properties, sql
from app.tools.constants import PREFETCH_MAX
from app.tools.misc import SENTINEL, ReadonlyDict, Sentinel, unique
...
_logger = logging.getLogger('app.fields')
...
class Field(typing.Generic[T]):
    ...
    def _get_attrs(self, model_class: type[BaseModel], name: str) -> dict[str, typing.Any]:
        ...
        if 'group_operator' in attrs:
            warnings.warn("Since DERACore 18, 'group_operator' is deprecated, use 'aggregator' instead", DeprecationWarning, stacklevel=2)
