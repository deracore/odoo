...
from app.tools import SQL, human_size
...
class Image(Binary):
    ...
    :param bool verify_resolution: whether the image resolution should be verified
        ...
        See :class:`app.tools.image.ImageProcess` for maximum image resolution (default: ``50e6``).
    ...
    def _image_process(self, value, env):
        ...
        from app.tools.image import image_process  # noqa: PLC0415
