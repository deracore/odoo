...
from app.exceptions import AccessError, UserError, MissingError
from app.tools import SQL, OrderedSet, is_list_of, html_sanitize
from app.tools.misc import frozendict, has_list_types
...
class Properties(Field):
    ...
    like DERACore fields but without being independently stored in database.
    ...
    current record. The container must have a :class:`~app.fields.PropertiesDefinition`
...
class PropertiesDefinition(Field):
    """ Field used to define the properties definition (see :class:`~app.fields.Properties`
