...
"""The DERACore API module defines method decorators.
"""
...
def constrains(*args) -> Decorator:
    ...
    Should raise :exc:`~app.exceptions.ValidationError` if the
    validation failed.
...
def ondelete(*, at_uninstall: bool) -> Decorator:
    """
    Mark a method to be executed during :meth:`~app.models.BaseModel.unlink`.
...
def onchange(*args: str) -> Decorator:
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/app/app/issues/2693>`_.
...
def autovacuum(method: C) -> C:
    ...
    as in :meth:`~app.addons.base.models.ir_cron.IrCron._commit_progress`.
    """
