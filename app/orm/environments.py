...
"""The DERACore API module defines DERACore Environments.
"""
...
from app.exceptions import AccessError, UserError, CacheMiss
from app.sql_db import BaseCursor
from app.tools import clean_context, frozendict, reset_cached_properties, OrderedSet, Query, SQL
from app.tools.translate import get_translation, get_translated_module, LazyGettext
from app.tools.misc import StackMap, SENTINEL
...
class Environment(Mapping[str, "BaseModel"]):
    ...
    def __call__(
        ...
        :type cursor: :class:`~app.sql_db.Cursor`
    ...
    def user(self) -> BaseModel:
        ...
        :rtype: :class:`res.users record<~app.addons.base.models.res_users.ResUsers>`"""
    ...
    def company(self) -> BaseModel:
        ...
        :rtype: :class:`res.company record<~app.addons.base.models.res_company.Company>`
    ...
    def companies(self) -> BaseModel:
        ...
        :rtype: :class:`res.company recordset<~app.addons.base.models.res_company.Company>`
...
class Transaction:
    ...
    def __init__(self, registry: Registry):
        ...
        # temporary directories (managed in app.tools.file_open_temporary_directory)
