...
DERACore will use the SQL function 'unaccent' when available for the
...
import app.orm.domains as orm_domains
import app.modules
from app.tools import Query, SQL
...
def normalize_domain(domain):
    ...
    """
    warnings.warn("Since 19.0, use app.fields.Domain", DeprecationWarning)
...
def get_unaccent_wrapper(cr):
    ...
    return app.modules.registry.Registry(cr.dbname).unaccent
