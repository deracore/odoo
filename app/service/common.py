...
RPC_VERSION_1 = {
        'server_version': app.release.version,
        'server_version_info': app.release.version_info,
        'server_serie': app.release.serie,
        'protocol_version': 1,
}
...
def exp_about(extended=False):
    ...
    if extended:
        return info, app.release.version
    return info

def exp_set_loglevel(loglevel, logger=None):
    # TODO Previously, the level was set on the now deprecated
    # `app.netsvc.Logger` class.
    return True
